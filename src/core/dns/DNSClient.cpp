...
TcpDNSResponse *DNSClient::tcpDns(const string &domain, const string &dnsServer, uint16_t port, uint32_t timeout) {
    vector<string> domains;
    domains.emplace_back(domain);
...
TcpDNSResponse *
DNSClient::tcpDns(const vector<string> &domains, const string &dnsServer, uint16_t port, uint32_t timeout) {
...
TcpDNSResponse *
DNSClient::queryTcp(const vector<string> &domains, const string &dnsServer, uint16_t port, uint32_t timeout) {
    ...
    try {
        ...
        socket.
                ...
                .shutdown(boost::asio::socket_base::shutdown_type::shutdown_both);
        socket.
        ...
        Logger::ERROR << dnsRequest.dnsHeader->id << ex.
