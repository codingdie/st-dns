...
def download(country_code):
    dir = "./country-ips/"
    filepath = dir + country_code
    if os.path.isfile(filepath):
        return
    response = urllib.urlopen('http://ip.bczs.net/country/' + country_code)
    html = response.read()
...
country_codes = ["US", "CN", "JP", "DE", "GB", "KR", "BR", "FR", "CA", "AU", "IT", "NL", "RU", "IN", "TW", "ES", "SE",
