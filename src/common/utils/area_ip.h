...
namespace st {
    namespace areaip {
        ...
        public:
            ...
            vector<area_ip_range> load_ip_info(const uint32_t &ip);
            static manager &uniq();
        ...
        private:
            ...
            unordered_map<string, vector<area_ip_range>> defaultCaches;
            unordered_map<string, vector<area_ip_range>> netCaches;
            mutex default_lock;
            mutex net_lock;
            ...
            bool is_area_ip(const string &areaCode, const uint32_t &ip, unordered_map<string, vector<area_ip_range>> &caches);
